function checkboxConcluido(checkbox, $id_usuario, $titulo) 
{
   if (checkbox.checked) {
         ...
         xhttp.open("POST", "../../js/checkbox-membro/concluido_if.php?id_usuario=" + $id_usuario + "&titulo=" + $titulo, true);
         xhttp.send();      
       ...
       xhttp.open("POST", "../../js/checkbox-membro/concluido_else.php?id_usuario=" + $id_usuario + "&titulo=" + $titulo, true);
       xhttp.send();
